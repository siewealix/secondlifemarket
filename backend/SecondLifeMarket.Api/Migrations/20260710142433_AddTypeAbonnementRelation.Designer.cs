...
namespace SecondLifeMarket.Api.Migrations
{
    ...
    [Migration("20260710142433_AddTypeAbonnementRelation")]
    partial class AddTypeAbonnementRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SecondLifeMarket.Api.Models.Abonnement", b =>
                {
                    ...
                    b.Property<int>("TypeAbonnementId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SecondLifeMarket.Api.Models.TypeAbonnement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SecondLifeMarket.Api.Models.Abonnement", b =>
                {
                    b.HasOne("SecondLifeMarket.Api.Models.TypeAbonnement", "TypeAbonnementNavigation")
                        .WithMany("Abonnements")
                        .HasForeignKey("TypeAbonnementId")
                    ...
                    b.Navigation("TypeAbonnementNavigation");
